...
test('v12 secure sharing uses fragment transport, server validation, and fragment redaction', () => {
...
test('v12 UI replaces legacy raw recovery-link sharing with expiring and revocable controls', () => {
